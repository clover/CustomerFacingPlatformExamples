...
package com.example.clover.customactivityshowcase.messages;
...
public class PayloadMessage {
  ...
  public static PayloadMessage fromJsonString(String m) {
    ...
    try {
      cls = (Class<? extends PayloadMessage>)Class.forName("com.example.clover.customactivityshowcase.messages." + payloadClassName);
